...
public class IntakeSubsys extends SubsystemBase {
  ...
  private final IntakeIOInputsAutoLogged inputs = new ElevatorIOInputsAutoLogged();
  ...
  public Angle getLastDesiredIntakePosInRotations() {
  ...
  public boolean isPositionedRotations(Angle position, Angle offset) {
    return MathUtil.isNear(
        ...
        getIntakePosInRotations().in(Units.Rotations),
        offset.in(Units.Rotations));
  }

  public boolean isAtDesiredPos() {
    return isPositionedRotations(
        getLastDesiredIntakePosInRotations(), Units.Rotations.of(IntakeConstants.MIN_OFFSET));
  }
  ...
  public void applyStates() {
    switch (subsystemState) {
      ...
      case STOPPING:
        ...
        break;
      case PREPARING_LVL:
        io.setPosition(desiredIntakePosition);
        break;
      case MANUAL:
